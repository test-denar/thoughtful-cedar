            ...
            <header className="site-header">
              <div className="container container--lg">
                <nav className="navbar" aria-label="Main Navigation">
                  ...
                  {_.get(this.props, 'pageContext.site.siteMetadata.header.logo') ? (
                  <Link className="navbar__logo" to={safePrefix('/')}><img src={safePrefix(_.get(this.props, 'pageContext.site.siteMetadata.header.logo'))} alt={_.get(this.props, 'pageContext.site.siteMetadata.header.title')} /></Link>
                  ) : 
                  <Link className="h4 navbar__title" to={safePrefix('/')}>{_.get(this.props, 'pageContext.site.siteMetadata.header.title')}</Link>
                  }
                    ...
                    <div className="navbar__scroller">
                      <div className="navbar__inner">
                        ...
                        <ul className="navbar__list menu">
                          ...
                          <li key={action_idx} className={classNames('navbar__item', {'navbar__item--btn': _.get(action, 'style') !== 'link', 'is-active': _.get(this.props, 'pageContext.url') === _.get(action, 'url')})}>
